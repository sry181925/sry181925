              ...
              Padding(
                ...
                child: GridView.count(
                  ...
                  children: [
                    ...
                    buildSizeGuides(
                      text: "5.5", color: Colors.white,
                    ),
                    buildSizeGuides(
                      text: "6", color: Colors.white,
                    ),
                    buildSizeGuides(
                      text: "6.5", color: Colors.white,
                    ),
                    buildSizeGuides(
                      text: "7", color: Colors.white,
                    ),
                    buildSizeGuides(
                      text: "7.5", color: Colors.white,
                    ),
                    buildSizeGuides(
                      text: "8", color: Colors.white,
                    ),
                    buildSizeGuides(
                      text: "8.5", color: Colors.white,
                    ),
                    buildSizeGuides(
                      text: "9", color: Colors.white,
                    ),
                    buildSizeGuides(
                      text: "9.5", color: Colors.white,
                    ),
                    buildSizeGuides(
                      text: "10", color: Colors.white,
                    ),
                    buildSizeGuides(
                      text: "10.5", color: Colors.white,
                    ),
                    buildSizeGuides(
                      text: "11", color: Colors.white,
                    ),
                    buildSizeGuides(
                      text: "11", color: Colors.white,
                    ),
