...
import 'package:e_jkmm/stylies/sub_category_stylies.dart';
...
class SubCategory extends StatefulWidget {
 final List<SingleProductModel> productData;
  ...
  SubCategory({Key? key, required this.productData, required this.productName, required this.productModel}) : super(key: key);
  @override
